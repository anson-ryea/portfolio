...
Under mitt akademiskt utbyte vid [Kungliga Tekniska högskolan (KTH)](https://www.kth.se/) gick jag med i forskningsgruppen HScala under [Prof. Philipp Haller](https://www.phaller.com/). Vår forskning fokuserar på att designa ett typsystem för heterogen exekvering av [Scala](https://www.scala-lang.org/) över nativa CPU- och SPIR-V-riktade GPU-körtidsmiljöer med hjälp av _Capture Tracking_, samt att utveckla den första kompilatorprototypen.
