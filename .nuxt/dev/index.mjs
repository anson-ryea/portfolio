...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/vue/index.mjs';
import { basename, isAbsolute } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/anson/Projects/portfolio-nuxt/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/anson/Projects/portfolio-nuxt/node_modules/ipx/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/anson/Projects/portfolio-nuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/anson/Projects/portfolio-nuxt","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/anson/Projects/portfolio-nuxt/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/anson/Projects/portfolio-nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/anson/Projects/portfolio-nuxt/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/anson/Projects/portfolio-nuxt/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/experiences/sql_dump": {
        "prerender": true
      },
      "/__nuxt_content/education/sql_dump": {
        "prerender": true
      },
      "/_fonts/**": {
        "headers": {
      ...
      "locales": [
        {
          ...
          "files": [
            {
              "path": "/Users/anson/Projects/portfolio-nuxt/i18n/locales/en.json",
              "cache": ""
            }
          ]
        },
        {
          ...
          "files": [
            {
              "path": "/Users/anson/Projects/portfolio-nuxt/i18n/locales/sv.json",
              "cache": ""
            }
          ]
        }
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/anson/Projects/portfolio-nuxt/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/anson/Projects/portfolio-nuxt/public"
      ]
    },
    "http": {
      "domains": []
...
const _yp0aiG28gnDqawtkOcJbydiEQ7f2XXVONmU5AUAgW1M = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/anson/Projects/portfolio-nuxt";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Anson Ng"};
...
const _lRwjS_ZTfWUueSkDrMAddmsxyo4CTF6J6ZR49IH584 = (nitroApp) => {
...
const plugins = [
  _yp0aiG28gnDqawtkOcJbydiEQ7f2XXVONmU5AUAgW1M,
_lRwjS_ZTfWUueSkDrMAddmsxyo4CTF6J6ZR49IH584
];
...
const _coUyGd = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/anson/Projects/portfolio-nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/anson/Projects/portfolio-nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _h2rMjs = eventHandler(async (event) => {
  ...
  return await import('file:///Users/anson/Projects/portfolio-nuxt/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _Ihsdxz = eventHandler(async (event) => {
...
const _UaVJfl = lazyEventHandler(() => {
...
const _lazy_lVD4nl = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_lVD4nl, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _coUyGd, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _h2rMjs, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _Ihsdxz, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _UaVJfl, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_lVD4nl, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lVD4nl, lazy: true, middleware: false, method: undefined }
];
