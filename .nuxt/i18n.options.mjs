...
// @ts-nocheck
import locale_en_46json_3de206a3 from "#nuxt-i18n/3de206a3";
import locale_sv_46json_557f293f from "#nuxt-i18n/557f293f";
...
export const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_3de206a3",
      load: () => Promise.resolve(locale_en_46json_3de206a3),
      cache: true
    }
  ],
  sv: [
    {
      key: "locale_sv_46json_557f293f",
      load: () => Promise.resolve(locale_sv_46json_557f293f),
      cache: true
    }
  ]
}
...
async function loadCfg(config) {
  ...
  import.meta.hot.accept("../i18n/locales/sv.json", async mod => {
    localeLoaders["sv"][0].load = () => Promise.resolve(mod.default)
    await useNuxtApp()._nuxtI18nDev.resetI18nProperties("sv")
  })
