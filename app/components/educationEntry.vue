  ...
  <div class="max-md:space-y-2 md:flex md:divide-x md:divide-gray-300 md:divide-dashed">
    <div class="flex flex-col max-md:space-y-2 md:justify-between md:w-36 lg:w-48 xl:w-64 md:pr-4">
      ...
      <div class="flex flex-wrap gap-1">
        ...
        <TagText v-for="tag in education.tags" :key="tag">
          {{ tag }}
        </TagText>
      </div>
    </div>
    <div class="md:pl-4 space-y-4 flex-1">
      <div class="space-y-2">
        <div class="flex items-center gap-2">
          ...
          >
            <div class="flex justify-between items-start">
              ...
              <span class="text-center text-2xs font-mono text-blue-600 uppercase">{{
                $t("about.education.gpa")
              }}</span>
            </div>
            <span class="block text-center font-serif text-2xl">
              {{ education.gpa
              }}<span class="text-xs text-gray-600">/{{ education.maxGpa.toFixed(1) }}</span>
            </span>
          </div>
        </div>
        <div>
        ...
        <p v-if="education.description" class="text-gray-600 font-serif">
      ...
      <div v-if="education.scholarships" class="relative group">
        <div
        ...
        >
          ...
          <div class="relative space-y-2 p-4 z-10">
            <h5 class="font-sans text-yellow-700 capitalize font-medium">
            ...
            >
              ...
              >
                ...
                <ul class="flex-1 divide-y divide-gray-300 pl-4">
                  <li
                    v-for="scholarship in scholarshipsGroupByYear?.get(year)"
