  ...
  >
    <motion.div
      ...
      :animate="{
        ...
        borderRadius: isHoveringTextElement ? '2px' : 'calc(infinity * 1px)',
        x: positionX + 'px',
        y: positionY + 'px',
      }"
    ...
    >
      <Icon v-show="isHoveringLink" name="solar:arrow-left-up-linear" class="bg-white h-4 w-4" />
...
const isHoveringTextElement = computed(() => {
  ...
  return (
    hoveringElement.value.tagName === "SPAN" ||
    hoveringElement.value.tagName === "LI" ||
    hoveringElement.value.tagName === "P" ||
    hoveringElement.value.tagName === "H1" ||
    hoveringElement.value.tagName === "H2" ||
    hoveringElement.value.tagName === "H3" ||
    hoveringElement.value.tagName === "H4" ||
    hoveringElement.value.tagName === "H5" ||
    hoveringElement.value.tagName === "H6"
  );
});
