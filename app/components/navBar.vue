  ...
  <motion.div :initial="{ opacity: 0, scale: 0 }" :animate="{ opacity: 1, scale: 1 }">
    ...
    >
      ...
      <div class="flex flex-col items-center">
        <NuxtLinkLocale to="/" class="capitalize">
          {{ $t("nav.home") }}
        </NuxtLinkLocale>
        <transition name="slide-up">
          <div
      ...
      <div class="flex flex-col items-center">
        <NuxtLinkLocale to="/about" class="capitalize">
          {{ $t("nav.about") }}
        </NuxtLinkLocale>
        <transition name="slide-up">
          <div
      ...
      >
        ...
        <transition name="slide-up">
          <div v-show="isExpanded.contact" class="h-0.5 w-4 bg-blue-600 rounded" />
        </transition>
      </button>
      <div class="flex flex-col items-center">
      ...
      >
        ...
        <transition name="slide-up">
          <div v-show="isExpanded.locale" class="h-0.5 w-4 bg-blue-600 rounded" />
        </transition>
      </button>
    </div>
  </motion.div>
